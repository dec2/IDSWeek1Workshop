...
nums <- c(18, 1, 5, 5, 14) #Extend if necessary
colours <- c("powderblue", "green3", "colour 2", "colour 2", "tomato3") #Extend if necessary
hobbies <- c("Hiking", "Swimming", "Hobby 2", "Hobby 3", "skiing") #Extend if necessary
